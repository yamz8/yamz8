...
Promptable events effectively expose “knobs” on the world. That’s a powerful tool for probing causality: swap weather, introduce objects, change affordances—observe whether behavior remains consistent.
